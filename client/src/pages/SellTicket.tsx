...
export default function SellTicket() {
  ...
  const handleSelectChange = (value: string) => {
    setFormData((prev) => ({ ...prev, ticketTypeId: value }));
  };
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle>Venda de Ingresso</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={formData.ticketTypeId} onValueChange={handleSelectChange}>
                    <SelectTrigger>
              ...
              <Button
                type="submit"
                disabled={!formData.ticketTypeId || createTicketMutation.isPending}
